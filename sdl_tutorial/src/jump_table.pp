...
# 1 "./jump_table.h" 1
# 33 "./jump_table.h"
typedef int (*JUMP_TABLE_ENTRY_opengl_core_init) (uint32_t a);
# 43 "./jump_table.c" 2
...
# 1 "./jump_table.h" 1
# 33 "./jump_table.h"
static int opengl_core_init_DEFAULT (uint32_t a);
# 48 "./jump_table.c" 2
...
# 1 "./jump_table.h" 1
# 33 "./jump_table.h"
extern int opengl_core_init_REAL (uint32_t a);
# 53 "./jump_table.c" 2
...
# 1 "./jump_table.h" 1
# 33 "./jump_table.h"
JUMP_TABLE_ENTRY_opengl_core_init opengl_core_init;
# 62 "./jump_table.c" 2
...
# 1 "./jump_table.h" 1
# 33 "./jump_table.h"
static int fn_DEFAULT (uint32_t a) { init_api(); return jump_table.opengl_core_init (a); }
# 92 "./jump_table.c" 2
...
# 1 "./jump_table.h" 1
# 33 "./jump_table.h"
int opengl_core_init (uint32_t a) { return jump_table.opengl_core_init (a); }
# 100 "./jump_table.c" 2
...
# 1 "./jump_table.h" 1
# 33 "./jump_table.h"
jump_table.opengl_core_init = opengl_core_init_REAL;
# 119 "./jump_table.c" 2
